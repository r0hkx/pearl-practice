...
execute if score int iIhPearlSlot matches 1 run replaceitem entity @a hotbar.0 ender_pearl{tag:"pearl"}
execute if score int iIhPearlSlot matches 2 run replaceitem entity @a hotbar.1 ender_pearl{tag:"pearl"}
execute if score int iIhPearlSlot matches 3 run replaceitem entity @a hotbar.2 ender_pearl{tag:"pearl"}
execute if score int iIhPearlSlot matches 4 run replaceitem entity @a hotbar.3 ender_pearl{tag:"pearl"}
execute if score int iIhPearlSlot matches 5 run replaceitem entity @a hotbar.4 ender_pearl{tag:"pearl"}
execute if score int iIhPearlSlot matches 6 run replaceitem entity @a hotbar.5 ender_pearl{tag:"pearl"}
execute if score int iIhPearlSlot matches 7 run replaceitem entity @a hotbar.6 ender_pearl{tag:"pearl"}
execute if score int iIhPearlSlot matches 8 run replaceitem entity @a hotbar.7 ender_pearl{tag:"pearl"}
execute if score int iIhPearlSlot matches 9 run replaceitem entity @a hotbar.8 ender_pearl{tag:"pearl"}
